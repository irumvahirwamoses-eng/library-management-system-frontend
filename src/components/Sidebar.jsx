...
import { LayoutDashboard, Book, Users, Grid3X3, BookOpen, Send, BarChart3, FileText, User, LogOut, ChevronRight, BookOpenCheck, Archive, History, ClipboardList, Activity, X } from 'lucide-react';
...
export default function Sidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col fixed top-0 bottom-0 left-0 z-50 transition-transform duration-300 lg:translate-x-0 ${open ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-5 border-b border-gray-100 flex items-center justify-between">
          ...
          <button onClick={onClose} className="lg:hidden p-2 -mr-2 text-gray-400 hover:bg-gray-100 rounded-lg transition" aria-label="Close menu">
            <X size={18} />
          </button>
        </div>
